...
class TestAPIIntegration:
    ...
    def test_debug_endpoint(self, api_tester):
        ...
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(data, indent=2)[:200]}{'...' if len(str(data)) > 200 else ''}{Colors.NC}")
    ...
    def test_upload_resume_no_file(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/upload-resume/ (no file) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(data, indent=2)[:200]}{'...' if len(str(data)) > 200 else ''}{Colors.NC}")
    ...
    def test_upload_resume_invalid_file(self, api_tester):
        ...
        try:
            ...
            print(
                f"{Colors.GREEN}✅ PASS: POST /api/v1/upload-resume/ (invalid file) (Status: {response.status_code}){Colors.NC}")
            print(
                f"{Colors.YELLOW}📄 Response: {json.dumps(data, indent=2)[:200]}{'...' if len(str(data)) > 200 else ''}{Colors.NC}")
    ...
    def test_upload_resume_success(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/upload-resume/ (valid PDF) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(data, indent=2)[:200]}{'...' if len(str(data)) > 200 else ''}{Colors.NC}")
    ...
    def test_get_keywords_no_doc_id(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/get-keywords/ (no doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(data, indent=2)[:200]}{'...' if len(str(data)) > 200 else ''}{Colors.NC}")
    ...
    def test_get_keywords_invalid_doc_id(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/get-keywords/ (invalid doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
    ...
    def test_get_keywords_valid(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/get-keywords/ (valid doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(response_data, indent=2)[:200]}{'...' if len(str(response_data)) > 200 else ''}{Colors.NC}")
    ...
    def test_target_job_missing_fields(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/target-job/ (missing doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(response_data, indent=2)[:200]}{'...' if len(str(response_data)) > 200 else ''}{Colors.NC}")
    ...
    def test_target_job_valid(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/target-job/ (valid data) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(response_data, indent=2)[:200]}{'...' if len(str(response_data)) > 200 else ''}{Colors.NC}")
    ...
    def test_get_questions_missing_doc_id(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/get-questions/ (missing doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(response_data, indent=2)[:200]}{'...' if len(str(response_data)) > 200 else ''}{Colors.NC}")
    ...
    def test_get_questions_valid(self, api_tester):
        ...
        print(
            f"{Colors.GREEN}✅ PASS: POST /api/v1/get-questions/ (valid doc_id) (Status: {response.status_code}){Colors.NC}")
        print(
            f"{Colors.YELLOW}📄 Response: {json.dumps(response_data, indent=2)[:200]}{'...' if len(str(response_data)) > 200 else ''}{Colors.NC}")
